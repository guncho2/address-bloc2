...
class MenuController
  ...
  def main_menu
    ...
    case selection
     ...
     #This method lists the available address books, and assigns the
     #book selected by the user to @address_book.:
  ...
  def view_all_entries
    ...
    # Entry.all.each do |entry|   #  Entry.order.(name: :ASC).each do |entry|
    @address_book.entries.each do |entry|
      Entry.order.(name: :ASC).each do |entry|
      system "clear"
      puts entry.to_s
      entry_submenu(entry)
    end
