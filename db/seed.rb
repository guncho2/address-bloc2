...
puts 'Address Book created'
 ...
 puts Entry.create(address_book_id: book.id, name: 'juan', phone_number: '888-888-8888', email: 'juan@gmail.com' )
 puts Entry.create(address_book_id: book.id, name: 'pedro', phone_number: '555-555-5555', email: 'pedro@gmail.com' )
...
Entry.destroy_all("email = 'foo_two@gmail.com'")
Entry.destroy_all("phone_number = '222-222-2222'")
...
# puts people(phone_number: '999-999-9999').not
